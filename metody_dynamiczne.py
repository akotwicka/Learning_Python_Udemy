...
Cake.export_1_cake_to_html = export_1_cake_to_html(cake01, path= r'C:\Users\Ola\Desktop\cake_01.html')

Cake.export_all_cakes_to_html = types.MethodType(export_all_cakes_to_html, Cake)
Cake.export_all_cakes_to_html(path = r'C:\Users\Ola\Desktop\cakes.html')

for i in Cake.bakery_offer:
    i.export_this_cake_to_html = types.MethodType(export_this_cake_to_html, i)

for i in Cake.bakery_offer:
    i.export_this_cake_to_html(path = r'C:\Users\Ola\Desktop\{}.html'.format(str.replace(i.name, " ", "_")))
